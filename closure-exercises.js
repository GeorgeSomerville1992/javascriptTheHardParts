...
function once(func) {
  ...
  let result;
	function output (num) {
    // func(num)
    /* one I didn't know if you pass the num is a param, it knows already
    // which makes sense */
    // * we need to pass that value back down*/
		if(counter === 1) {
      /* out put value from the first time it was called */
      return result;
    } else {
      counter +=1;
      result = func(num);
...
// rememeber you can pass  a param here
...
function delay(func, wait) {
	// the settimtpuot partt
  // and how it works with Javascipt.
